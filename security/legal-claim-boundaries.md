...
- The model is fair across the world.
- The model will behave the same on all future prompts.
- The explanation is the model's human-like reasoning.
- A black-box provider has an internal circuit certified.
- Legal but-for causation has been proven without outside validation.

## Required Before Legal-Grade Use

- Independent protocol review.
- Independent reproduction.
- Expert sign-off on the claim scope.
- Customer legal review.
- Preserved report hashes and chain of custody.
